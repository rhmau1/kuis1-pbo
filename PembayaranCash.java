public class PembayaranCash extends Pembayaran {
    ...
    public PembayaranCash(String idPembayaran, double jumlah, String tanggal, String status,
            String namaPenerima, double uangDiterima, String lokasiPembayaran) {
        super(idPembayaran, jumlah, tanggal, status); // pakai parameter status
    ...
    public void prosesPembayaran() {
        ...
        if (uangDiterima >= jumlah) {
            ...
            System.out.println("Kembalian: Rp " + (uangDiterima - jumlah));
        } else {
            this.status = "Gagal";
