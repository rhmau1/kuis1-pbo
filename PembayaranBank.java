public class PembayaranBank extends Pembayaran {
    ...
    public PembayaranBank(String idPembayaran, double jumlah, String tanggal, String namaBank, String nomorRekening,
            String namaPemilik) {
    ...
    private void generateKodeTransaksi() {
        if (namaBank.length() > 3) {
            this.kodeTransaksi = namaBank.substring(0, 3).toUpperCase() +
                    System.currentTimeMillis() % 1000000;
        } else {
            this.kodeTransaksi = namaBank.toUpperCase() +
                    System.currentTimeMillis() % 1000000;
